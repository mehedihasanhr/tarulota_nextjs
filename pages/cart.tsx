            ...
            <div className={styles.__table_con}>
              ...
              <div className={styles.__table}>
                <div className={styles.__table_header}>
                  <div className={`${styles.__th} ${styles.__td_1}`}>Image</div>
                  <div className={`${styles.__th} ${styles.__td_2}`}>Title</div>
                  <div className={`${styles.__th} ${styles.__td_3}`}>
                    Quantity
                  </div>
                  <div className={`${styles.__th} ${styles.__td_4}`}>Price</div>
                  <div className={`${styles.__th} ${styles.__td_5}`}>
                    Discount
                  </div>
                  <div className={`${styles.__th} ${styles.__td_6}`}>Total</div>
                </div>
          ...
          <div className="col-3">
            <div className={styles.__checkout}>
              ...
              <div className={styles.__checkout_item}>
                <span className={styles.__checkout_item_label}>Sub Total</span>
